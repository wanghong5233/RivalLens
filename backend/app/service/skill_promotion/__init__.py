...
def _build_qa_rule_markdown(
    *,
    ...
    frontmatter = {
        "name": skill_id,
        "description": "Promoted QA rule generated by RivalLens Skill Curator.",
        "version": "1.0.0",
...
def _build_prompt_template_markdown(
    *,
    ...
    frontmatter = {
        "name": skill_id,
        "description": "Promoted prompt template generated by RivalLens Skill Curator.",
        "version": "1.0.0",
        "tags": list(record.tags),
        "applies_to": _resolve_applies_to(record),
        "source": _entry_meta(record=record, reviewed_by=reviewed_by, reviewed_at=reviewed_at),
...
def _build_source_routing_markdown(
    *,
    ...
    frontmatter = {
        "name": skill_id,
        "description": "Promoted source routing preference generated by RivalLens Skill Curator.",
        "version": "1.0.0",
        "tags": list(record.tags),
        "applies_to": _resolve_applies_to(record),
        "source": _entry_meta(record=record, reviewed_by=reviewed_by, reviewed_at=reviewed_at),
