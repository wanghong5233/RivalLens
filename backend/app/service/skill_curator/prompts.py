...
SKILL_CURATOR_QA_RULE_SYSTEM_PROMPT = """You are RivalLens Skill Curator for QA rule candidates.
...
SKILL_CURATOR_PROMPT_TEMPLATE_SYSTEM_PROMPT = """You are RivalLens Skill Curator for prompt template candidates.
...
SKILL_CURATOR_SOURCE_ROUTING_SYSTEM_PROMPT = """You are RivalLens Skill Curator for source routing candidates.
